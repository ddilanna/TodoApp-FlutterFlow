              ...
              child: Column(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/Screenshot_2025-02-10_at_6.48.47_PM.png',
                      width: 120.0,
                      fit: BoxFit.cover,
                    ),
                  ),
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        contentPadding:
                                            EdgeInsetsDirectional.fromSTEB(
                                                24.0, 26.0, 24.0, 26.0),
                                        suffixIcon: _model.email1TextController!
                                                .text.isNotEmpty
                                            ? InkWell(
                                                onTap: () async {
                                                  _model.email1TextController
                              ...
                              Column(
                                ...
                                children: [
                                  Container(
                                    width: double.infinity,
                                    child: TextFormField(
                                      controller: _model.email2TextController,
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        contentPadding:
                                            EdgeInsetsDirectional.fromSTEB(
                                                24.0, 26.0, 24.0, 26.0),
                                        suffixIcon: _model.email2TextController!
                                                .text.isNotEmpty
                                            ? InkWell(
                                                onTap: () async {
                                                  _model.email2TextController
